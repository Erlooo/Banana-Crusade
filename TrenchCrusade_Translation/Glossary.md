...
| FIRE | FOGO |
| GÁS | GÁS |
| IGNORE ARMOUR | IGNORAR ARMADURA |
| CRITICAL | CRÍTICO |
| RISKY | ARRISCADO |
| DESPATCH | EXECUÇÃO |
...
| Learned Saint | Santo Estudioso |
| Infernal Noble | Nobre Infernal |
| Sublime Gate | Portal Sublime |
| Order of the Fly | Ordem da Mosca |
| Mammon | Mammon |
| Antipope of Avignon | Antipapa de Avignon |
