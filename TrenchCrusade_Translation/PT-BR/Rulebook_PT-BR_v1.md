...
Na primeira seção, você encontrará uma linha do tempo de eventos significativos na história do mundo e um breve relato do mundo e das principais facções que lutam na Grande Guerra.
...
## Uma Linha do Tempo Breve e Incompleta de Trench Crusade

**ca. 1072:** Sinais celestiais ominosos alertam para a ruptura do plano de Deus. Cultos heréticos se multiplicam. A Ordem dos Cavaleiros Templários é estabelecida. Eles miram a captura do Monte do Templo.

**1099:** A Primeira Cruzada captura Jerusalém. Os Cavaleiros Templários cometem o Ato da Heresia Suprema. O Portal do Inferno aparece na Terra. Jerusalém é destruída no cataclismo.

**1101:** O Ano das Três Batalhas. Os Heréticos, reforçados pelos exércitos do Terceiro Círculo do Inferno, conquistam a totalidade do Levante.

**1102:** A antiga cidade de Antioquía é fortificada e torna-se o ponto focal de resistência contra as forças do Inferno.
...
**1477:** A Cidade de Argos é tomada por Deus e não existe mais.

**1503:** O Profeta de Guerra Angelos, guiado por Santo Elegius, descobre a fórmula para o aço de orichalcum. Embora exorbitantemente caro de produzir, o metal prova ser altamente eficaz contra todos os projéteis e continua em uso até hoje.
...
**1910:** A Batalha de Córdoba resulta em um impasse sangrento. A artilharia Herética oblitera a antiga cidade, mas suas forças falham em ganhar acesso ao interior da Hispânia.

**1914:** O presente. Ambos os lados estão se preparando para grandes operações ofensivas. Escaramuças e incursões se intensificam por toda a vasta extensão da Terra de Ninguém enquanto os Fiéis e os Heréticos disputam informações cruciais, relíquias poderosas e posições estratégicas.
...
A primeira seção do livro de regras é chamada de Regras Centrais e explica como jogar Trench Crusade em um formato rápido e fácil de usar. As Regras Centrais são seguidas pela seção de Regras Completas, que fornece explicações mais detalhadas das regras e informações adicionais sobre como elas funcionam. Se você estiver usando as Regras Centrais e encontrar uma situação que não sabe como resolver, consulte as Regras Completas para encontrar a resposta.

Uma partida de Trench Crusade é dividida em Turnos, que são separados em uma Fase de Iniciativa, uma Fase de Ativação e uma Fase de Moral.
...
| 2 a 6 | Falha. |
| 7 a 11 | Sucesso. |
| 12+ | Sucesso Crítico. Adicione +1 DADO DE FERIMENTO a Ataques a Distância ou Corpo a Corpo se você tirar um Sucesso Crítico. |
...
Para cada +DADO, adicione 1 dado ao Teste de Sucesso. Em seguida, role todos os dados e escolha os 2 resultados mais altos. Por exemplo, +1 DADO significa que você rola 3 dados e escolhe os 2 mais altos. Se +2 DADOS forem adicionados, role 4 dados e escolha os 2 mais altos, e assim por diante.

O -DADO funciona de forma inversa. Para cada -DADO, adicione 1 dado ao Teste de Sucesso e escolha os 2 números mais baixos. Por exemplo, -1 DADO significa que você rola 3 dados e escolhe os 2 mais baixos.

Se tanto +DADO quanto -DADO forem adicionados ao mesmo Teste de Sucesso, remova pares de +DADO e -DADO até que apenas um tipo restante. Por exemplo, se uma rolagem tiver +2 DADOS e -1 DADO, um dos +1 DADO e o -1 DADO seriam removidos, deixando +1 DADO para ser adicionado à rolagem.

---

## Combate

O combate é dividido em Ataques a Distância e Ataques Corpo a Corpo. Ataques a Distância são realizados quando você faz uma AÇÃO de Atirar com um modelo, e Ataques Corpo a Corpo quando você faz uma AÇÃO de Lutar com um modelo.
...
Para fazer um Teste de Ferimento, role dois dados e adicione quaisquer +DADOS DE FERIMENTO ou -DADOS DE FERIMENTO à rolagem. +/-DADOS DE FERIMENTO funcionam da mesma forma que +/-DADOS, mas modificam Testes de Ferimento em vez de Testes de Sucesso. Escolha os dois dados mais altos (ou mais baixos se algum -DADO DE FERIMENTO foi usado). Quaisquer MODIFICADORES DE FERIMENTO que se apliquem são então adicionados à rolagem, e a rolagem modificada é consultada na tabela abaixo:
...
- **Em Testes de Ferimento:** Quando seu oponente fizer um Teste de Ferimento contra o modelo, ele pode gastar um ou mais MARCADORES DE SANGUE para adicionar +1 DADO DE FERIMENTO por marcador gasto, tornando um ferimento grave muito mais provável.
...
> **Quem rola e quem gasta?** Você sempre faz Testes de Ferimento para modelos inimigos e gasta os MARCADORES DE SANGUE/INFECÇÃO que eles possuem. Da mesma forma, seu oponente sempre faz as Testes de Ferimento para seus modelos e gasta os MARCADORES DE SANGUE/INFECÇÃO deles. Cada jogador gasta os MARCADORES DE BÊNÇÃO de seus próprios modelos.
...
Após a Fase de Moral, o Turno termina e um novo começa.
...
Isso é você e seu oponente! As regras a seguir foram escritas assumindo que o jogo é disputado entre dois jogadores.
...
Para medir distâncias, você precisará de uma fita métrica ou régua. Trench Crusade usa o sistema Imperial de medidas, o que significa que todas as medidas são em polegadas, então certifique-se de que seu instrumento de medição reflita isso.

### DADOS (D6s E D3s)

Cada jogador precisará de vários dados de 6 lados, referidos como "D6s" nas regras a seguir. Eles são usados para determinar se uma tarefa sendo realizada por um modelo, como fazer um ataque ou saltar sobre uma lacuna entre dois edifícios, é realizada com sucesso (ver Ações).
...
Algumas palavras nas regras são escritas em LETRAS MAIÚSCULAS, como AÇÃO ou MARCADOR DE SANGUE. Essas palavras são chamadas Palavras-Chave, e definem as habilidades centrais, regras, tipos de tropa e categorias de dano no jogo. Um glossário de todas as Palavras-Chave usadas no jogo pode ser encontrado abaixo (ver Glossário de Palavras-Chave).
...
| Rolagem | Resultado |
|---------|-----------|
| 2-6 | Falha. A rolagem é uma Falha. |
...
**+DADO:** Para cada +DADO, adicione 1 dado ao Teste de Sucesso. Em seguida, role todos os dados e escolha os 2 resultados mais altos. Por exemplo, +1 DADO significa que você rola 3 dados e escolhe os 2 mais altos. Se +2 DADOS forem adicionados, você rolaria 4 dados e escolheria os 2 mais altos, e assim por diante.

**-DADO:** O -DADO funciona de forma inversa, então para cada -1 DADO, adicione 1 dado ao Teste de Sucesso e escolha os 2 resultados mais baixos. Por exemplo, -1 DADO significa que você rola 3 dados e escolhe os 2 mais baixos. Se -2 DADOS forem adicionados, você rolaria 4 dados e escolheria os 2 mais baixos, e assim por diante.

**Combinando +DADO e -DADO**

Se tanto +DADO quanto -DADO forem adicionados ao mesmo Teste de Sucesso, remova pares de +DADO e -DADO até que apenas um tipo reste. Por exemplo, se dois +DADOS e um -DADO forem adicionados ao mesmo Teste de Sucesso, um +DADO cancelaria o -DADO, deixando um único +DADO para modificar a rolagem.
...
Cada vez que um de seus modelos sofrer um ferimento, coloque um MARCADOR DE SANGUE ao lado dele. Um modelo não pode ter mais de 6 MARCADORES DE SANGUE ao mesmo tempo. Quando um modelo chegar a esse ponto, ignore quaisquer instruções para colocar mais MARCADORES DE SANGUE ao lado dele até que haja menos de 6.
...
Alternativamente, quando seu oponente fizer um Teste de Ferimento para um modelo do seu Bando que tenha MARCADORES DE SANGUE, ele pode declarar que está gastando um ou mais deles, removendo os MARCADORES DE SANGUE do modelo conforme são gastos. Para cada MARCADOR DE SANGUE gasto, adicione +1 DADO DE FERIMENTO ao Teste de Ferimento, tornando um ferimento grave muito mais provável (ver Testes de Ferimento).
...
Cada vez que um de seus modelos receber uma bênção, coloque um MARCADOR DE BÊNÇÃO ao lado dele. Um modelo não pode ter mais de 6 MARCADORES DE BÊNÇÃO ao mesmo tempo. Quando um modelo chegar a esse ponto, ignore quaisquer instruções para colocar mais MARCADORES DE BÊNÇÃO ao lado dele até que haja menos de 6.
...
Alternativamente, quando seu oponente fizer um Teste de Ferimento para um modelo do seu Bando que tenha MARCADORES DE BÊNÇÃO, você pode declarar que está gastando um ou mais deles, removendo os MARCADORES DE BÊNÇÃO do modelo conforme são gastos. Para cada MARCADOR DE BÊNÇÃO gasto, adicione -1 DADO DE FERIMENTO ao Teste de Ferimento, tornando um ferimento grave muito menos provável.

**Rastreando Marcadores de Sangue e Bênção**

Você pode rastrear o número de MARCADORES DE SANGUE ou MARCADORES DE BÊNÇÃO que um modelo tem colocando um D6 de cor adequada ao lado do modelo. Use o número no D6 para indicar o número de MARCADORES que foram adicionados ao modelo. Alternativamente, você pode rastrear usando fichas de cartolina ou cubos de madeira. Por exemplo, você poderia usar um dado vermelho ou cubos vermelhos para rastrear MARCADORES DE SANGUE, e um dado amarelo ou cubos amarelos para rastrear MARCADORES DE BÊNÇÃO.
...
|-----------|-----------|---------------|----------|------|
| 6"/Infantaria | +0 DADO | -1 DADO | 0 | 25mm |
...
Dois modelos estão em contato se qualquer parte dos modelos e/ou suas bases estiverem em contato. Um modelo está em contato com uma peça de terreno se qualquer parte do modelo e/ou sua base estiver em contato com a peça de terreno.
...
Algumas regras se referem a rerrolagens. Para fazer uma rerrolagem, role os dados usados para a rolagem novamente. Você não pode rerolar um dado mais de uma vez. Se as regras permitirem que você rerrole uma rolagem de XD6 (ou seja, 2D6, 3D6, etc.), você deve rerolar todos os dados usados para a rolagem.
...
No início de cada Turno, você deve determinar qual jogador tem a Iniciativa para o Turno e então realizar quaisquer tarefas de início de Turno. O jogador com a Iniciativa escolhe qual jogador realizará a primeira Ativação na Fase de Ativação.
...
Durante a Fase de Ativação, os jogadores alternam Ativando seus modelos um de cada vez até que ambos os jogadores tenham Ativado todos os seus modelos uma vez cada. O jogador com a Iniciativa escolhe qual jogador Ativa um modelo primeiro.
...
- Um modelo só pode se mover para dentro de 1" de modelos inimigos se investir (ver Investida).
...
Após selecionar o alvo, role um D6 e adicione o resultado à Característica de Movimento do modelo investindo, até um máximo de Característica de Movimento de 12". A rolagem do D6 é referida como o Bônus de Investida do modelo.
...
Se a lacuna que um modelo está Saltando for mais alta no lado de onde ele está Saltando, aplique as regras para Pular Para Baixo se o modelo Saltar a lacuna. Se a lacuna for mais alta no lado para onde ele está Saltando, adicione a altura extra à distância horizontal do Salto. (Isso pode tornar o Salto impossível se a distância modificada for maior que a distância que o modelo pode se mover.)

**Pulando Para Baixo**

Quando você move um modelo, ele pode Pular Para Baixo como parte do movimento. Pular Para Baixo não afeta a distância que você pode mover o modelo (o Pulo Para Baixo é "gratuito"). No entanto, se um modelo Pular Para Baixo 3" ou mais, isso conta como Queda e você deve fazer um Teste de Ferimento para o modelo antes de continuar com seu movimento (ver Queda).
...
Quando você realiza uma AÇÃO de Atirar com um modelo, você faz um Ataque a Distância com ele. Quando você realiza uma AÇÃO de Lutar com um modelo, você faz um Ataque Corpo a Corpo com ele. As regras nesta seção explicam como cada tipo de ataque é feito.
...
Um Ataque a Distância é feito usando a seguinte sequência:
...
Em seguida, você deve determinar se há modificadores que afetarão o ataque. Modificadores adicionam +/-DADOS ao Teste de Sucesso.
...
Quando você faz um Ataque Corpo a Corpo com um modelo, deve primeiro escolher uma Arma Corpo a Corpo com a qual o modelo está equipado para fazer o ataque. As Armas com as quais um modelo está equipado podem ser encontradas em seu Perfil.

**Escolhendo o Alvo**

Quando um modelo faz um Ataque Corpo a Corpo, você deve escolher um modelo inimigo para ser o alvo do ataque. O alvo deve estar dentro de 1" do modelo atacante em sua Linha de Visão (ver Linha de Visão).

**Determinar Modificadores de Ataque Corpo a Corpo**

Em seguida, você deve determinar se há modificadores que afetarão o ataque. Modificadores adicionam +/-DADOS ao Teste de Sucesso para o modelo atacante.

- **Investida Mergulhante (+1 DADO):** Adicione +1 DADO à rolagem se o atacante estiver fazendo uma Investida Mergulhante (ver Investida Mergulhante).
...
**MODIFICADOR DE FERIMENTO:** +/-MODIFICADORES DE FERIMENTO são aplicados ao Teste de Ferimento. Faça o Teste de Ferimento, adicionando quaisquer +/-DADOS DE FERIMENTO, e então adicione ou subtraia quaisquer MODIFICADORES DE FERIMENTO da rolagem. O máximo de -MODIFICADOR DE FERIMENTO não pode ser mais que -3 no total.

Por exemplo, um Teste de Ferimento tem um modificador de +1 DADO DE FERIMENTO e um -1 MODIFICADOR DE FERIMENTO. 3 dados são rolados, resultando em 2, 4 e 5. Os dois dados mais altos são usados, dando uma rolagem de 9. Então o -1 MODIFICADOR DE FERIMENTO é aplicado, subtraindo 1 da rolagem e mudando-a para 8. A rolagem é consultada na Tabela de Ferimento, que dá um resultado Derrubado para o Teste de Ferimento.
...
*Exemplo de jogo: Um Soldado Herético faz um Ataque a Distância que acerta um Castigador Peregrino das Trincheiras que tem 2 MARCADORES DE SANGUE e Armadura Padrão. O jogador Herético decide usar ambos os MARCADORES DE SANGUE para tornar o tiro mais provável de ferir. O jogador Herético pega 4D6 (2D6 +2 DADOS DE FERIMENTO dos MARCADORES DE SANGUE) e rola 2, 5, 4 e 1. Como dois +DADOS DE FERIMENTO foram adicionados à rolagem, os dois números mais altos são usados para o Teste de Ferimento, dando um total de 9. A armadura do Castigador adiciona -1 MODIFICADOR DE FERIMENTO, então o total é reduzido em 1, para dar uma rolagem modificada de 8. O jogador Herético consulta a Tabela de Ferimento e descobre que o Peregrino está Derrubado!*
...
As regras que governam todas as Palavras-Chave no jogo estão listadas aqui. Um modelo, uma peça de Equipamento de Batalha, um Marcador ou uma peça de terreno pode ter 1 ou mais Palavras-Chave. Elas definem as habilidades centrais, regras, tipos de tropa e categorias de dano no jogo. Palavras-Chave aparecem nas regras em MAIÚSCULAS para facilitar a identificação.

---

## Benefícios das Palavras-Chave

Palavras-Chave têm dois benefícios: elas atuam como Etiquetas e podem conferir um Efeito. Uma Palavra-Chave que confere um Efeito também atua como Etiqueta.

**Etiquetas:** Uma Palavra-Chave que pode ser referenciada por outras regras.

**Efeito:** Uma Palavra-Chave que confere uma regra especial a um modelo que possui a Palavra-Chave, ou que possui uma peça de Equipamento de Batalha que tenha essa Palavra-Chave.
...
Modificadores que são aplicados ao resultado de um Teste de Ferimento (ver Testes de Ferimento). Se a Palavra-Chave se aplica a uma Arma, o modificador é adicionado apenas às Testes de Ferimento para Ataques feitos com ela.
...
### IMPERVIO (Efeito)
Os Efeitos de PERFURA ARMADURA e IGNORAR ARMADURA não afetam quaisquer -DADOS DE FERIMENTO e -MODIFICADORES DE FERIMENTO que se apliquem a Equipamento de Batalha que possua esta Palavra-Chave. Qualquer outro Equipamento de Batalha que o modelo alvo tenha é afetado normalmente.
...
### NEGAR [PALAVRA-CHAVE] (Efeito)
Um modelo com a Palavra-Chave NEGAR não é afetado pelo Efeito da Palavra-Chave especificada. Por exemplo, um modelo com NEGAR ESTILHAÇO ignora o Efeito da Palavra-Chave ESTILHAÇO.
...
- Trincheiras
- Edifícios em Ruínas (uma torre, casa, etc.)
- Ruínas de Canto (dois muros em ruínas em forma de L)
- Rios e Riachos

### TERRENO ABERTO

Terreno Aberto é qualquer área de um campo de batalha onde não há nada para impedir um modelo, e é o tipo de terreno mais comum em Trench Crusade. Modelos podem se mover livremente pelo Terreno Aberto.
...
Os jogadores fazem um desempate (ver Desempate), é o vencedor monta o terreno para a partida. As peças de terreno para uma partida ocorrendo na Terra de Ninguém devem ser escolhidas da seguinte lista:
...
As peças de terreno devem ser montadas de forma que cada peça de terreno esteja a pelo menos 3" de quaisquer outras peças de terreno. Trincheiras só podem ser montadas se estiverem inteiramente dentro de uma das Zonas de Posicionamento mostradas no mapa para o cenário que está sendo jogado.
...
Você precisará de pelo menos 6 edifícios em ruínas e pelo menos 2 peças de cada outro tipo de terreno. Conte peças que tenham mais de 8" de largura ou mais de 8" de comprimento como sendo 2 peças de terreno para esse número, em vez de apenas 1.
...
Você precisará de Trincheiras suficientes para alcançar de uma borda do campo de batalha até a borda oposta. Além das trincheiras, você precisará de pelo menos 2 peças de cada outro tipo de terreno. Conte peças que tenham mais de 8" de largura ou mais de 8" de comprimento como sendo 2 peças de terreno para esse número, em vez de apenas 1.
...
- **Perfil de Equipamento de Batalha:** Um Perfil de Equipamento de Batalha inclui o nome do Equipamento de Batalha e as seguintes informações:
  ...
  - **Alcance:** Indica a distância na qual o Equipamento de Batalha pode ser usado para fazer um ataque.
    - *Armas a Distância:* Se o alcance é um valor em polegadas (ex: 12"), o Equipamento de Batalha é uma Arma a Distância e pode ser usado para fazer Ataques a Distância.
...
## Limites de Equipamento de Batalha

A menos que declarado de outra forma, um modelo está limitado ao seguinte Equipamento de Batalha:

- Uma Arma a Distância de 2 Mãos ou duas Armas a Distância de 1 Mão.
- Uma Arma Corpo a Corpo de 2 Mãos ou duas Armas Corpo a Corpo de 1 Mão.
- Um tipo de Granada.
- Uma Armadura.
...
A menos que declarado de outra forma, assume-se que um modelo tem:

- Duas mãos para carregar armas e equipamentos.
...
Armas a Distância podem ser usadas para realizar um Ataque a Distância (ver Ataques a Distância). Armas a Distância não podem ser usadas para fazer um Ataque Corpo a Corpo, a menos que tenham a palavra "Corpo a Corpo" anotada em seu Alcance no Perfil.

### Rifle Antimaterial

Enormes rifles longos projetados para eliminar alvos pesadamente blindados, veículos e posições fortificadas. Com a poderosa armadura disponível para os exércitos da Grande Guerra, essas armas aterrorizantes são muito procuradas. Um ponto negativo é seu enorme peso e recuo aterrorizante, e portanto são mais frequentemente usados por Comunicantes ou Ungidos que possuem a força sobrenatural para empunhar tais armas.
...
| Tipo | Alcance | Palavras-Chave |
|------|---------|----------------|
| 1 Mão | 12"/Corpo a Corpo | ASSALTO, AUTOMÁTICO 2, PISTOLA |
...
Esta espingarda é equipada com um carregador automático, uma invenção recente do corpo de engenharia prussiano de Königsberg. É ideal para combate em espaços fechados graças a sua alta cadência de fogo e precisão. A tecnologia não foi aperfeiçoada, no entanto, e às vezes causa falhas de alimentação e travamentos.

| Tipo | Alcance | Palavras-Chave |
|------|---------|----------------|
| 2 Mãos | 12" | +1 DADO, ASSALTO, ESPINGARDA |
...
| Tipo | Alcance | Palavras-Chave |
|------|---------|----------------|
| 2 Mãos | 36" | EXPLOSÃO 3", PESADO, IGNORAR COBERTURA, ESTILHAÇO |

### Lança-Chamas Pesado

Esses lança-chamas massivos são normalmente montados em veículos blindados, mas aqueles que possuem força sobrenatural podem usá-los como armas de infantaria.
...
| Tipo | Alcance | Palavras-Chave |
|------|---------|----------------|
| 2 Mãos | 36" | AUTOMÁTICO 3, PESADO, RECARREGAR |
...
Armas Corpo a Corpo podem ser usadas para realizar um Ataque Corpo a Corpo (ver Ataque Corpo a Corpo). Armas Corpo a Corpo não podem ser usadas para fazer um Ataque a Distância, a menos que tenham um valor em polegadas anotado em seu Alcance no Perfil.
...
Baionetas são lâminas em forma de espigões ou adagas que podem ser fixadas na ponta de uma arma de fogo e usadas em combate corpo a corpo.

| Tipo | Alcance | Palavras-Chave |
|------|---------|----------------|
| 2 Mãos | Corpo a Corpo | VOLUMOSO |
...
| Tipo | Alcance | Palavras-Chave |
|------|---------|----------------|
| 2 Mãos | Corpo a Corpo | +1 MODIFICADOR DE FERIMENTO, PESADO |
...
| Tipo | Alcance | Palavras-Chave |
|------|---------|----------------|
| 2 Mãos | Corpo a Corpo | BLOQUEIO, VOLUMOSO |
...
*Explosivo Pesado:* Uma vez durante uma partida, um modelo com uma Investida Explosiva pode usá-la para fazer um Ataque a Distância.
...
Escudos usados na guerra de trincheiras são feitos de aço reforçado com orichalcum para permitir que resistam até balas de alto calibre, ou de metal minerado do leito rochoso Infernal e moldado nas armarias de Pandemonio, a capital do Inferno.

| Tipo | Alcance | Palavras-Chave |
|------|---------|----------------|
| Escudo | - | -1 MODIFICADOR DE FERIMENTO |
...
| Tipo | Alcance | Palavras-Chave |
|------|---------|----------------|
| Armadura | - | -2 MODIFICADOR DE FERIMENTO |
...
| Tipo | Alcance | Palavras-Chave |
|------|---------|----------------|
| Armadura | - | -1 MODIFICADOR DE FERIMENTO |
...
| Tipo | Alcance | Palavras-Chave |
|------|---------|----------------|
| Equipamento | - | NEGAR ESTILHAÇO |

### Balas Dum-Dum

Essas balas de ponta oca são muito mais propensas a causar ferimentos fatais do que munição padrão.
...
*Êxodo Flamejante:* Se um modelo com um Contrato de Alma Condenada for colocado Fora de Ação, antes de removê-lo do campo de batalha, adicione 1 MARCADOR DE SANGUE a cada modelo inimigo que esteja dentro de 1" dele. Modelos que tenham a Palavra-Chave NEGAR FOGO não são afetados por esta regra especial.
...
Cornetas, tambores, trombetas, apitos, gaitas de foles e muitos outros tipos de instrumentos são usados extensivamente nas batalhas da Grande Guerra. Eles podem fortalecer os corações daqueles que enfrentam os horrores do Inferno, ou podem recitar hinos aterrorizantes louvando os senhores do Inferno!
...
- **Químicos Mendelistas:** O jogador adversário não pode gastar MARCADORES DE SANGUE ao lado de um modelo com esta habilidade para adicionar +1 DADO DE FERIMENTO (eles podem usar os MARCADORES DE SANGUE para converter a rolagem em uma Rolagem de Banho de Sangue normalmente).
...
- **Escola de Franco-Atiradores:** Ataques a Distância feitos por um modelo com esta Habilidade precisam de 1 MARCADOR DE SANGUE a menos para converter um Teste de Ferimento em uma Rolagem de Banho de Sangue.
- **Treinamento Especial de Assalto:** Ataques Corpo a Corpo feitos por um modelo com esta Habilidade precisam de 1 MARCADOR DE SANGUE a menos para converter um Teste de Ferimento em uma Rolagem de Banho de Sangue.
...
- **Matador de Dragões:** Quando você fizer um Teste de Ferimento para um Ataque Corpo a Corpo feito por um modelo com esta Habilidade, você pode mudar o resultado de um dos D6s usados para o Teste de Ferimento para 6.
...
- **Corretamente Guiado:** No início da partida, após o posicionamento, você pode escolher 1 AÇÃO além de Investir, Atirar ou Lutar que exija que um modelo inimigo seja escolhido como alvo da AÇÃO ou seja escolhido para ser afetado pela AÇÃO. Pelo resto da partida, o modelo com esta Habilidade não pode ser escolhido como alvo daquela AÇÃO e não pode ser escolhido para ser afetado por aquela AÇÃO.
...
Uma vez que você tenha escolhido o Patrono de seu Bando, você está pronto para iniciar a campanha! Uma campanha é jogada vinculando as partidas individuais que você joga. Você pode jogar uma partida de campanha contra qualquer um dos outros jogadores que estejam participando; tudo o que você precisa fazer é combinar um horário e local para a partida, reunir-se e então selecionar o cenário que você vai jogar (ver Selecionando um Cenário de Campanha), e então jogar a partida usando as regras normais. Após a partida, você realiza uma Fase de Campanha onde descobre o destino dos modelos que foram colocados Fora de Ação, vê se algum modelo ganhou novas Habilidades, explora a região onde a campanha está acontecendo e usa qualquer saque que capturou para recrutar mais modelos para seu Bando.
...
4. Reclamar a Terra de Ninguém
5. Caça ao Dragão
6. O jogador que jogou menos partidas escolhe.

**Final de Campanha (Partidas 9-11)**

Role um D6:

1. Guerra de Trincheiras
2. Caça ao Dragão
3. Vindo de Baixo
4. Campos de Glória
5. Não Respire
...
**Batalha Final (Partida 12):** A Grande Guerra

**Opção de Escolha:** Após gerar aleatoriamente um cenário, se ambos os jogadores concordarem, podem trocar o cenário rolado por outro da mesma tabela.
...
Quando você termina uma partida de campanha, você e seu oponente devem realizar uma Fase de Campanha.

### ETAPAS DA FASE DE CAMPANHA
...
Nesta etapa da Fase de Campanha, você deve descobrir o que aconteceu com modelos que foram colocados Fora de Ação durante a partida.
...
| 31 | **Ferimento na Perna.** Subtraia 2" da Característica de Movimento deste modelo. Além disso, adicione -1 DADO ao Teste de Sucesso Arriscado deste modelo quando realizar uma AÇÃO de Correr. |
...
### TABELA DE HABILIDADES DE CORPO A CORPO E FORÇA
...
| 6 | **Investida Implacável:** Adicione +1 DADO a rolagens para Ataques Corpo a Corpo feitos por um modelo com esta Habilidade se ele tiver investido com sucesso anteriormente na mesma Ativação. |
...
| 10 | **Golpe Cirúrgico:** Uma vez por Ativação, antes de fazer um Teste de Ferimento para um Ataque Corpo a Corpo feito por um modelo com esta Habilidade, você pode dizer que a rolagem tem a Palavra-Chave IGNORAR ARMADURA. |
| 11 | **Campeão:** Armas Corpo a Corpo que não possuam a Palavra-Chave GOLPE VARRENTE usadas por um modelo com esta Habilidade ganham a Palavra-Chave GOLPE VARRENTE 2. Além disso, adicione -1 DADO ao Teste de Sucesso para o segundo Ataque Corpo a Corpo feito com cada Arma Corpo a Corpo que ganhe a Palavra-Chave GOLPE VARRENTE. |
...
| 6 | **Atlético:** Adicione +1 DADO a Testes de Sucesso Arriscados para um modelo com esta Habilidade quando Escalar, Saltar ou fazer uma Investida Mergulhante, e adicione -1 DADO DE FERIMENTO a Testes de Ferimento se Cair. |
| 7 | **Velocista:** Adicione +1 DADO ao Teste de Sucesso Arriscado para um modelo com esta Habilidade que esteja realizando uma AÇÃO de Correr. |
...
Nesta etapa, você tem a chance de explorar o território sobre o qual a campanha está acontecendo.

### SEQUÊNCIA DE EXPLORAÇÃO

1. Determine o número de Dados de Exploração que você recebe.
2. Role os Dados de Exploração.
3. Use Aliados, Equipamento e Habilidades de Exploração para modificar a Rolagem de Exploração.
4. Consulte a Tabela de Exploração para ver o que você descobriu.
5. Colete saque igual a 10 vezes sua Rolagem de Exploração em 👑.

**Determinar Dados de Exploração**

| Partidas Jogadas | Dados de Exploração |
|------------------|---------------------|
| 1-2 | 3 Dados de Exploração |
| 3-5 | 4 Dados de Exploração |
...
- **Voltar:** Subtraia 1 de sua Rolagem de Exploração.
- **Sortudo:** Após a Rolagem de Exploração, selecione um dos dados e role um dado extra. Você pode manter o dado que escolheu ou substituí-lo pelo dado extra.

### TABELA DE EXPLORAÇÃO DE LOCAIS COMUNS
...
| 9 | **Posto de Radio Profético Abandonado:** Seu Bando ganha a Habilidade de Exploração Dado Extra. |
...
| 10 | **Passagens Escondidas:** Seu Bando ganha a Habilidade de Exploração Duplicar. |
...
| Livro de Orações de Batalha | ELITE only, Limite: 1 | 7 ☼ |
| Armadura Alada Ducal | Título ou Nobreza only, Limite: 1 | 18 ☼ |
| Hospital de Campo | Limite: 1 | 10 ☼ |
| Grande Estandarte de Nova Antioquia | Limite: 1 | 12 ☼ |
...
| Item de Glória | Restrição | Custo |
|----------------|-----------|-------|
| Armadura de Damasco | ELITE only, Limite: 1 | 5 ☼ |
| Hospital de Campo | Limite: 1 | 10 ☼ |
| Kilij | ELITE only, Limite: 2 | 2 ☼ |
| Nobreza | ELITE only, Limite: 1 | 4 ☼ |
...
O livro de regras inclui os seguintes cenários:

| Número | Cenário |
|--------|---------|
| I | Reclamar a Terra de Ninguém |
| II | Caça aos Heróis |
| III | Caça à Relíquia |
...
Um cenário de Trench Crusade inclui as seguintes informações:

### MAPA DO JOGO

O mapa para um cenário mostra as Zonas de Posicionamento para cada lado e onde colocar quaisquer Marcadores que precisem ir em um local específico.
...
*Lute pelo controle de um trecho de terra e expulse seus inimigos.*
...
**Infiltradores:** Podem usar regras especiais; modelos atacantes devem ser posicionados dentro de 12" de sua Zona de Posicionamento.
...
- **Sobreviver para Contar:** Modelo amigo sobrevive a 2 Testes de Ferimento por explosões de minas.
...
*Pela glória de seu Patrono, cace e derrote uma criatura monstruosa, seja um tanque possuído ou uma besta infernal.*
...
*Conquiste um campo de batalha marcado por crateras, mas tenha cuidado para não despertar a besta que dorme abaixo.*
...
**Feitos Gloriosos:**
- **Sede de Sangue:** Modelo envenenado usa Banho de Sangue para colocar inimigo envenenado Fora de Ação.
...
*Mostre sua força e bravura. Lute até a gloriosa morte e deixe sua lenda viver.*
